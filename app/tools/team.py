...
def lookup_team_season_stats(year: int, team_id: int = 0, team_name: str = "", season_type: str = "Regular Season") -> str:
    ...
    try:
        ...
        frame=leaguedashteamstats.LeagueDashTeamStats(season=season, season_type_all_star=season_type, team_id_nullable=str(team_id) if team_id else "", timeout=20).get_data_frames()[0]
