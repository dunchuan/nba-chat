...
def lookup_boxscore_data(game_id: str) -> str:
    ...
    try:
        ...
        frames = boxscoretraditionalv3.BoxScoreTraditionalV3(game_id=str(game_id), timeout=20).get_data_frames()
...
def lookup_player_season_stats(year: int, player_name: str = "", season_type: str = "Regular Season") -> str:
    ...
    try:
        ...
        frame = leaguedashplayerstats.LeagueDashPlayerStats(season=season, season_type_all_star=season_type, timeout=20).get_data_frames()[0]
...
def lookup_player_career_stats(player_id: int = 0, player_name: str = "") -> str:
    ...
    try:
        ...
        frames = playercareerstats.PlayerCareerStats(player_id=int(player_id), timeout=20).get_data_frames()
